...
/*
  ...
  Since the delete removes the object from the state this one is easy to implement.
*/
    ...
    <div className="container-card">
      <div className="card">
        ...
        <div className="card__side card__side--back">
           ...
           <img onClick={updatecard}  src={update} alt='U'/>          {/*update*/}
          <img onClick={deletecard}  src={close} alt='X'/>        {/*delete*/}
          </div>
