...
export  const Buttons  = (props)=>{
  let {delMaster,masterid, updMaster, visible, title} = props;
  return (
    <div style={ !visible ? { display: 'flex'} : {display:'none'} } className="master__svg ">

      <svg  onClick={()=>updMaster(true,masterid, title)}  version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 30 30">
