...
export  const Buttons  = (props)=>{
  let {deleteMaster,masterinfo, showMasterForm} = props;

  return (
    <div  className="master__svg ">

        <svg onClick={()=>showMasterForm(true,masterinfo.id, masterinfo.title)}  version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 30 30">
        ...
        <svg   onClick={()=>deleteMaster(masterinfo.id)}  version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 30 30">
...
// .props.deleteMaster
// onClick={()=>updMaster(true,masterid, title)}
// onClick={()=>delMaster(masterid)}
// visible,
